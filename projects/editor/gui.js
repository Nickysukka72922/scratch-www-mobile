...
<html lang="en" class="no-js ">
  <head>
    <meta charset="utf-8" />
    <link rel="canonical" href="https://tlecms.mit.edu/spotlight/designing-proteins-saturday" />
...
<div class="es-search-mod" id="search-app"
  ...
  <div class="spotlight__media spotlight__media--single-image spotlight__media--full-width">
    ...
    <figure class="spotlight__figure spotlight__figure--full">
              <a class="spotlight__figure-link" target="_blank" href="http://news.mit.edu/2026/bringing-ai-driven-protein-design-tools-everywhere-0417">
                <img class="spotlight__img" src="/files/images/202604/MIT-OpenProteinAI-SL.jpg" alt="Circling arrows depict the looping process and say: “Test; Learn; Generate; Review; Build…” with stylized proteins in center.">
              </a>
                </figure>
            ...
            <span>Spotlight: Apr 18, 2026</span>
          </h2>
        
          <div class="spotlight__text js-hang-punc ">
                        
            <p><a target="_blank" href="http://OpenProtein.AI">OpenProtein.AI</a> is helping biologists stay on the cutting edge of AI with a no-code platform for protein engineering. To give scientists the best tools to develop new treatments faster, “it’s really important to create open ecosystems around AI and biology,” Tim Lu says.</p>

      
          </div>

          <div class="spotlight__meta js-spotlight-meta">
            <h4 class="spotlight__date">Apr 18, 2026</h4>
                          <a target="_blank" href="http://news.mit.edu/2026/bringing-ai-driven-protein-design-tools-everywhere-0417" class="spotlight__text__cta js-spotlight-text-cta">Full story</a>
            ...
            <div class="spotlight__share js-spotlight-share">
              ...
              <ul class="spotlight__share-list">
                <li class="spotlight__share-item">
                  <a href="https://twitter.com/share?url=http://web.mit.edu/spotlight/designing-proteins-saturday" target="_blank" class="spotlight__share-link js-share-link">
                ...
                <li class="spotlight__share-item">
                  <a href="https://www.facebook.com/sharer/sharer.php?u=http://web.mit.edu/spotlight/designing-proteins-saturday" target="_blank" class="spotlight__share-link js-share-link">
...
<div class="spotlight-addl-content-block">
  <div class="spotlight-addl-content-block--inner">
    <div class="spotlight-addl-content-block--img">
        ...
        <a target="_blank" href="http://news.mit.edu/2026/carbon-removal-project-supports-maines-blue-economy-broader-marine-health-0414">
            
              <img loading="lazy" src="/files/images/202604/Blue-Economy_02dw.jpg" width="759" height="506" alt="Aerial view of boats in an oyster farm" typeof="foaf:Image" />
    ...
    <div class="spotlight-addl-content-block--text">
      ...
      <div class="spotlight-addl-content-block--title">
        <h3>
            ...
            <p>Ocean acidification threatens shellfish in Maine; MIT scientists are helping by working with fisheries to pull CO2 from seawater using electrodes. “Without science, we don’t have a prayer of continuing this industry,” oyster farmer Bill Mook says.</p>
...
<div class="spotlight-addl-content-block">
  <div class="spotlight-addl-content-block--inner">
    <div class="spotlight-addl-content-block--img">
        ...
        <a target="_blank" href="http://news.mit.edu/2026/toward-cheaper-cleaner-hydrogen-production-0403">
            
              <img loading="lazy" src="/files/images/202604/MIT-1S1-Energy-SLsub.jpg" width="600" height="400" alt="Sphere with water and the letter &quot;H&quot; for hydrogen" typeof="foaf:Image" />
    ...
    <div class="spotlight-addl-content-block--text">
      ...
      <div class="spotlight-addl-content-block--title">
        <h3>
            ...
            <p>Hydrogen is key to many industrial processes, but its production is energy-intensive. But 1s1 Energy, co-founded by alumnus Dan Sobek, has developed an electrochemical cell material for hydrogen electrolyzers that it says reduces energy use by 30 percent.</p>
...
<div class="spotlight-addl-content-block">
  <div class="spotlight-addl-content-block--inner">
    <div class="spotlight-addl-content-block--img">
        ...
        <a target="_blank" href="http://news.mit.edu/2026/lincoln-laboratory-laser-communications-terminal-launches-artemis-ii-0402">
            
              <img loading="lazy" src="/files/images/202604/artemis-ii-launch-nasa-00_dw.jpg" width="700" height="467" alt="Artemis spacecraft launches, with lots of smoke." typeof="foaf:Image" />
    ...
    <div class="spotlight-addl-content-block--text">
      ...
      <div class="spotlight-addl-content-block--title">
        <h3>
            ...
            <p>NASA’s Orion spacecraft is carrying four astronauts and a state-of-the-art communications system developed at MIT Lincoln Laboratory on its way to the moon. The system uses lasers to send high-res video and images of the lunar surface down to Earth.</p>
...
<div class="spotlight-addl-content-block">
  <div class="spotlight-addl-content-block--inner">
    <div class="spotlight-addl-content-block--img">
        ...
        <a target="_blank" href="http://news.mit.edu/2026/wristband-enables-wearers-control-robotic-hand-with-own-movements-0325">
            
              <img loading="lazy" src="/files/images/202603/MIT-Hand-Tracker-SLsub.jpg" width="600" height="400" alt="A researcher training a robotic hand" typeof="foaf:Image" />
    ...
    <div class="spotlight-addl-content-block--text">
      ...
      <div class="spotlight-addl-content-block--title">
        <h3>
            ...
            <p>Engineers designed a wristband that lets wearers control a robotic hand with their own movements. By moving their hands and fingers, users can direct a robot to play piano or shoot a basketball, or manipulate objects in a virtual environment. </p>
    ...
    <div class="spotlight-addl-content-block--text">
      ...
      <div class="spotlight-addl-content-block--title">
        <h3>
            ...
            <div id="node-spotlight" data-viewingspotlight=' Designing proteins - Saturday'>
